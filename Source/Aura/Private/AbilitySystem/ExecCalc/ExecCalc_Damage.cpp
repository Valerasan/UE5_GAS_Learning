                                              ...
                                              FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
	...
	for(const auto& Pair : FAuraGameplayTags::Get().DamageTypesToResistances)
	{
		...
		checkf(AuraDamageStatics().TagsToCaptureDefs.Contains(ResistanceTag), TEXT("TagsToCaptureDefs doesn`t caontains Tag: [%s] in ExecCalc_Damage"), *ResistanceTag.ToString());
	...
	// ArmorPenetration ignore a percent of the Target`s Armor
	...
	// CriticalHitResistance reduce CriticalHitChance by a certain percentage
