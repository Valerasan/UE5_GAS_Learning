...
#pragma region SecondaryAttributes
	...
	UPROPERTY(BlueprintReadOnly, ReplicatedUsing = OnRep_HealRegeneration, Category = "Primary Attributes")
	FGameplayAttributeData HealRegeneration;
	ATTRIBUTE_ACCESSORS(UAuraAttributeSet, HealRegeneration);
...
#pragma endregion
	...
	UFUNCTION()
	void OnRep_HealRegeneration(const FGameplayAttributeData& OldHealRegeneration) const;
	...
	UFUNCTION()
	void OnRep_FireResistance(const FGameplayAttributeData& Old_FireResistance) const;

	UFUNCTION()
	void OnRep_LightningResistance(const FGameplayAttributeData& Old_LightningResistance) const;

	UFUNCTION()
	void OnRep_ArcaneResistance(const FGameplayAttributeData& Old_ArcaneResistance) const;

	UFUNCTION()
	void OnRep_PhysicalResistance(const FGameplayAttributeData& Old_PhysicalResistance) const;

private:
	void SetEffectProperties(const FGameplayEffectModCallbackData& Data, FEffectProperties& Props) const;
	void ShowFloatingText(const FEffectProperties& Props, float Damage, bool bIsBlocked, bool bCriticalHit) const;
};
